...
/**
 * ProGableRoofHouse: 普通小房子 (屋檐已上移修正)
 */
...
export class GrStripedStore extends GrObject {
    constructor(name = "Store") {
        ...
        createAwning(0.8, 6, 0, 0.35, 0.75); // 正面遮阳帘偏移避开门
...
export class GrChurch extends GrObject {
    ...
    /**
     * stepWorld: 钟表随系统时间转动 (为了效果明显，代码中使用了 *10 加速流逝)
     */
    stepWorld(delta, time) {
        // time 是毫秒，seconds 是秒
        // 如果想看真实时间，保持 seconds = time / 1000
        // 这里可以使用加速系数（比如 * 10）让指针转动更明显
